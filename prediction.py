...
model.predict(source='Datasets/3heads_merged_dataset/47_37_val_logos_dataset/issue_checking/Engelbert Strauss/images', project = 'Datasets/3heads_merged_dataset/47_37_val_logos_dataset/issue_checking/Engelbert Strauss/prediction',imgsz=640, name = "pred1_640" , conf = 0.01, save=True)